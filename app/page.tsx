      ...
      <section className="flex min-h-screen items-center justify-center px-6 pt-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600">
            Kami adalah sebuah kelompok yang terdiri dari individu-individu
            dengan semangat, tujuan, dan visi yang sama.
          </p>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-bold md:text-4xl">
              Mengenal kelompok kami lebih dekat.
            </h2>

            <p className="mt-6 leading-8 text-gray-600">
              Kami percaya bahwa kolaborasi dan kerja sama dapat menghasilkan
              sesuatu yang lebih besar. Website ini dibuat sebagai tempat
              untuk mengenal kelompok kami, anggota kami, serta berbagai
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-end justify-between">
            ...
            <Link
              href="/anggota"
              className="hidden font-semibold text-blue-600 hover:underline md:block"
            >
              Lihat semua →
            </Link>
          </div>
    ...
    >
      ...
      <p className="mt-1 text-sm text-gray-500">
        {member.role}
          ...
          <Link
            href="/anggota"
            className="mt-8 inline-block font-semibold text-blue-600 hover:underline md:hidden"
          >
            Lihat semua →
          </Link>
        </div>
      ...
      <section className="px-6 pb-24">
        <div className="mx-auto max-w-6xl overflow-hidden rounded-3xl bg-blue-600 px-6 py-16 text-center text-white md:px-16">
          ...
          <p className="mx-auto mt-4 max-w-xl text-blue-100">
            Jangan ragu untuk menghubungi kami jika ingin mengetahui lebih
            lanjut mengenai kelompok kami.
          </p>

          <Link
            href="/kontak"
            className="mt-8 inline-block rounded-full bg-white px-6 py-3 font-semibold text-blue-600 transition hover:bg-blue-50"
          >
            Hubungi Kami
          </Link>
        </div>
