    ...
    <div class="container py-5">
        <div class="card card-custom">
            <div class="card-body p-4">
                <h2 class="fw-bold mb-3">Edit Murid</h2>
                <p class="text-muted mb-4">Ubah data murid yang sudah terdaftar.</p>
                ...
                <form action="{{ route('murid.update', $murid->id) }}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-2">
                            ...
                            <input type="number" name="nisn" class="form-control" value="{{ old('nisn', $murid->nisn) }}" required>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="alamat" class="form-control" value="{{ old('alamat', $murid->alamat) }}" required>
                        </div>
